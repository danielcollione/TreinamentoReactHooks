...
function Calculadora() {
  ...
  function definirOp(op){
    //Apenas define a operação caso ela não exista.
    if(operacao === null){
      setOperacao(op);
      return;
    }
    //Caso a operação estiver definida e número 2 selecionado, realiza o calculo da operação.
    if(numero2 !== null){
  ...
  return (
    ...
    <Jumbotron
      ...
      <Container>
        <Row>
          <Col xs="3"> <Button variant="danger" onClick={limpar}>C</Button> </Col>
          <Col xs="9">
        ...
        <Row>
          ...
          <Col> <Button variant= "warning" onClick={() => definirOp(DIV)}>/</Button> </Col>
        </Row>
        ...
        <Row>
          ...
          <Col> <Button variant= "warning" onClick={() => definirOp(MULT)}>*</Button> </Col>
        </Row>
        ...
        <Row>
          ...
          <Col> <Button variant= "warning" onClick={() => definirOp(SUB)}>-</Button> </Col>
        </Row>
        ...
        <Row>
          ...
          <Col> <Button variant= "warning" onClick={() => definirOp(SOMA)}>+</Button> </Col>
        </Row>
